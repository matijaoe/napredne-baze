...
START TRANSACTION;
INSERT INTO menze (naziv, adresa)
VALUES ('Menza Voltino', 'Konavoska 2');
INSERT INTO menze (naziv, adresa)
VALUES ('Menza Vrbik', 'Vrbik 8a');
SELECT *
FROM menze;
ROLLBACK;
SET autocommit = 1;
...
SHOW VARIABLES WHERE variable_name = 'autocommit';
START TRANSACTION;
INSERT INTO menze2 (naziv, adresa)
VALUES ('Menza Voltino', 'Konavoska 2');
INSERT INTO menze2 (naziv, adresa)
VALUES ('Menza Vrbik', 'Vrbik 8a');
ROLLBACK;
...
BEGIN WORK;
INSERT INTO menze
VALUES (10, 'naziv1', 'adresa1');
INSERT INTO menze
VALUES (10, 'naziv2', 'adresa2');
COMMIT WORK;
SELECT *
FROM menze;
